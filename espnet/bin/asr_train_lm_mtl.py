...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        "--scheduled-sampling", default=0.0, type=float, help="Scheduled sampling ratio"
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=int,
        help="Maximum seqs in a minibatch for LM training(0 to disable)",
    )
    parser.add_argument(
        "--batch-bins",
        default=0,
    ...
    if args.use_ddp:
        ...
        if args.num_spkrs == 1:
            if args.backend == "chainer":
                ...
                from espnet.asr.pytorch_backend.asr_lm_mtl import train
